...
export class VehicleMaintenanceTab {
  ...
  protected saveRecord() {
    ...
    request$.pipe(finalize(() => this.isSaving.set(false))).subscribe({
      ...
      error: () => {
        this.actionError.set('Unable to save service record. Please try again.');
      },
    });
  }
  ...
  protected deleteSelectedRecord() {
    ...
    this.http
      ...
      .subscribe({
        ...
        error: () => {
          this.actionError.set('Unable to delete service record. Please try again.');
        },
      });
  }
  ...
  private loadServiceRecords() {
    ...
    this.http
      ...
      .subscribe({
        ...
        error: () => {
          this.serviceRecords.set([]);
          this.error.set('Unable to load service records right now.');
        },
      });
  }
